...
Route::middleware(['auth', 'verified', 'project.not-suspended', 'onboarding.complete'])->group(function () {
    ...
    Route::post('/portal/chat-messages/{message}/react', [PortalChatController::class, 'react'])->name('portal.chat.react');
...
Route::middleware(['auth', 'admin', 'admin-page-access'])->prefix('admin')->name('admin.')->group(function () {
    ...
    // Dismissing a banner you can see, or browsing your own announcement
    // history, shouldn't require the "Announcements" management permission
    // (that one gates create/edit/delete), so these opt out of admin-page-access.
    ...
    Route::get('/intake-submissions/create', [AdminIntakeSubmissionController::class, 'create'])->name('intake-submissions.create');
    Route::post('/intake-submissions', [AdminIntakeSubmissionController::class, 'store'])->name('intake-submissions.store');
    ...
    Route::delete('/intake-submissions/{intakeSubmission}', [AdminIntakeSubmissionController::class, 'destroy'])->name('intake-submissions.destroy');
    ...
    Route::delete('/project-requests/{projectRequest}', [AdminProjectRequestController::class, 'destroy'])->middleware('super-admin')->name('project-requests.destroy');
    ...
    Route::post('/chat-messages/{message}/react', [AdminChatController::class, 'react'])->name('chat.react');
    ...
    Route::patch('/uploads/{upload}/completion-note', [UploadApprovalController::class, 'updateCompletionNote'])->name('uploads.completion-note');
