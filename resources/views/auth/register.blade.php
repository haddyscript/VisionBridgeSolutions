...
@section('content')
    <h1 class="font-display text-2xl font-bold text-navy mb-1">Create Your Account</h1>
    <p class="text-gray-500 text-sm mb-6">Get access to your project's client portal.</p>
    ...
    <p class="text-center text-sm text-gray-500 mt-6">
        Already have an account? <a href="{{ route('login') }}" class="text-gold-dark font-medium hover:underline">Sign in</a>
    </p>
@endsection
