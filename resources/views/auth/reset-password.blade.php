...
@section('content')
    <h1 class="font-display text-3xl font-extrabold text-navy mb-1">Reset Password</h1>
    <p class="text-gray-700 text-base font-medium mb-6">Choose a new password for your account.</p>
    ...
    <form method="POST" action="{{ route('password.store') }}" class="space-y-4">
        ...
        <div>
            <label class="block text-base font-bold text-navy mb-1">New Password</label>
            <input type="password" name="password" required
                   class="w-full rounded-lg border border-gray-300 px-4 py-2.5 text-base focus:outline-none focus:ring-2 focus:ring-gold focus:border-gold">
        </div>

        <div>
            <label class="block text-base font-bold text-navy mb-1">Confirm New Password</label>
