...
@section('content')
    <h1 class="font-display text-2xl font-bold text-navy mb-1">Forgot Password</h1>
    <p class="text-gray-500 text-sm mb-6">Enter your email and we'll send you a password reset link.</p>
    ...
    <p class="text-center text-sm text-gray-500 mt-6">
        <a href="{{ route('login') }}" class="text-gold-dark font-medium hover:underline">Back to sign in</a>
    </p>
@endsection
