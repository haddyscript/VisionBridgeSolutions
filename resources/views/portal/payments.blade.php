        ...
        @else
            <div class="space-y-3">
                @foreach ($payments as $payment)
                    <div class="flex flex-wrap items-center justify-between gap-4 rounded-xl border border-gray-100 dark:border-gray-700/60 px-5 py-4 hover:border-gold/30 hover:shadow-sm transition-all">
                        <div class="flex items-center gap-4">
