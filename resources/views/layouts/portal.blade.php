    ...
    <div class="flex min-h-screen">
        ...
        <aside id="portal-sidebar" class="fixed inset-y-0 left-0 z-40 w-64 flex flex-col -translate-x-full md:translate-x-0 transition-transform duration-200" style="background:#111D33;">
            ...
            <nav class="flex-1 overflow-y-auto gold-scrollbar py-5 px-3 space-y-0.5">
                ...
                {{-- Always visually distinct from every other nav item here
                     (not just on its own active route) — a permanent
                     gold-tinted pill + a small "live" dot on the icon, so
                     the one genuinely real-time feature in this sidebar
                     doesn't read as just another plain link a client could
                     easily scroll past. --}}
