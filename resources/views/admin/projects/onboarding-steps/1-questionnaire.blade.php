...
<div class="grid grid-cols-1 lg:grid-cols-2 gap-6">
    ...
    <div class="bg-white dark:bg-gray-800 rounded-2xl border border-gray-200 dark:border-gray-700 p-7">
        ...
        <div class="space-y-4">
            <div>
                ...
                <textarea rows="3" class="w-full rounded-lg border border-gray-300 dark:border-gray-600 px-4 py-2.5 text-sm bg-gray-50 dark:bg-gray-900 dark:text-white">{{ $questionnaire?->mission_statement ?: '—' }}</textarea>
            </div>
            <div>
                <label class="block text-sm font-semibold text-navy dark:text-white mb-1">Vision Statement</label>
                <textarea rows="3" class="w-full rounded-lg border border-gray-300 dark:border-gray-600 px-4 py-2.5 text-sm bg-gray-50 dark:bg-gray-900 dark:text-white">{{ $questionnaire?->vision_statement ?: '—' }}</textarea>
            </div>
        </div>
    </div>
    ...
    <div class="bg-white dark:bg-gray-800 rounded-2xl border border-gray-200 dark:border-gray-700 p-7">
        ...
        <textarea rows="4" class="w-full rounded-lg border border-gray-300 dark:border-gray-600 px-4 py-2.5 text-sm bg-gray-50 dark:bg-gray-900 dark:text-white">{{ $questionnaire?->requested_pages ?: '—' }}</textarea>
    </div>
    ...
    <div class="bg-white dark:bg-gray-800 rounded-2xl border border-gray-200 dark:border-gray-700 p-7 lg:col-span-2">
        ...
        <textarea rows="3" class="w-full rounded-lg border border-gray-300 dark:border-gray-600 px-4 py-2.5 text-sm bg-gray-50 dark:bg-gray-900 dark:text-white">{{ $questionnaire?->additional_notes ?: '—' }}</textarea>
    </div>
