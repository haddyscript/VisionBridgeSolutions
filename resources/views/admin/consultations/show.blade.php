                    ...
                    <a href="tel:{{ $consultation->phone }}" class="flex items-center gap-2.5 text-sm text-gray-600 dark:text-gray-300 hover:text-gold-dark">
                        ...
                        <span>
                            ...
                            @if ($consultation->country)
                                <span class="text-gray-400 dark:text-gray-500">({{ $consultation->country }})</span>
                            @endif
                        </span>
                    </a>
                @endif
            ...
            <form method="POST" action="{{ route('admin.consultations.update', $consultation) }}" id="consultation-update-form" class="pt-5 border-t border-gray-100 dark:border-gray-700/60 space-y-5">
                ...
                <div class="flex items-center gap-3">
                    ...
                    <select name="status" id="status-select"
                            class="flex-1 rounded-lg border border-gray-300 dark:border-gray-600 px-3 py-2 text-sm font-medium focus:outline-none focus:ring-2 focus:ring-gold focus:border-gold dark:bg-gray-900 dark:text-white"
                ...
                <div class="flex items-start gap-3">
                    <svg class="w-5 h-5 mt-2 shrink-0 text-gray-400 dark:text-gray-500" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M12 8v4l3 3m6-3a9 9 0 11-18 0 9 9 0 0118 0z"/></svg>
                ...
                <div class="flex items-start gap-3">
                    <svg class="w-5 h-5 mt-2 shrink-0 text-gray-400 dark:text-gray-500" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M15 10l4.553-2.276A1 1 0 0121 8.618v6.764a1 1 0 01-1.447.894L15 14M5 18h8a2 2 0 002-2V8a2 2 0 00-2-2H5a2 2 0 00-2 2v8a2 2 0 002 2z"/></svg>
                    <div class="flex-1">
                ...
                <div class="flex items-start gap-3">
                    <svg class="w-5 h-5 mt-2 shrink-0 text-gray-400 dark:text-gray-500" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M4 6h16M4 12h16M4 18h7"/></svg>
                    <textarea name="admin_notes" rows="4" placeholder="Internal notes about this booking..."
                              class="flex-1 rounded-lg border border-gray-300 dark:border-gray-600 px-3 py-2 text-sm focus:outline-none focus:ring-2 focus:ring-gold focus:border-gold dark:bg-gray-900 dark:text-white dark:placeholder-gray-500">{{ old('admin_notes', $consultation->admin_notes) }}</textarea>
                </div>
