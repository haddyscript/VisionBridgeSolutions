...
<div class="upload-attach">
    ...
    <p class="text-xs text-gray-400 dark:text-gray-500 mt-1.5">Optional — specs, contracts, reference files, anything beyond the formal proposal document (up to 25MB each).</p>
</div>
