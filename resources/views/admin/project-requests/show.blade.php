    ...
    <div class="grid grid-cols-1 lg:grid-cols-5 gap-6 items-start">
        ...
        <div class="lg:col-span-3 space-y-6">
            ...
            <div class="bg-white dark:bg-navy rounded-xl border border-gray-200 dark:border-gray-700 p-6">
                ...
                @php $descriptionClosingHtml = $projectRequest->descriptionClosingHtml(); @endphp
                @if ($descriptionClosingHtml !== '')
                    <p class="text-xs text-gray-400 dark:text-gray-500 whitespace-pre-line mt-3 pt-3 border-t border-gray-100 dark:border-gray-700">{!! $descriptionClosingHtml !!}</p>
                @endif
                ...
                <div>
                    ...
                    @include('admin._dropdown', [
                        ...
                        'options' => collect(\App\Models\ProjectRequest::STATUSES)->map(fn ($label, $value) => [
                            'value' => $value,
                            'label' => $label,
                            'dot' => ['pending' => 'bg-amber-400', 'reviewed' => 'bg-indigo-400', 'in_progress' => 'bg-gold', 'converted' => 'bg-teal', 'declined' => 'bg-red-400', 'duplicated' => 'bg-gray-400', 'done' => 'bg-emerald-400'][$value] ?? 'bg-gray-400',
                        ])->values()->all(),
