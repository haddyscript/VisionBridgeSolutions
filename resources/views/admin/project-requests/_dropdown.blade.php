...
<div class="relative" data-custom-select id="{{ $domId }}-wrap" data-auto-submit="{{ $autoSubmit ? '1' : '0' }}">
    ...
    <div id="{{ $domId }}-menu" class="hidden absolute z-20 left-0 right-0 mt-1.5 bg-white dark:bg-navy border border-gray-200 dark:border-gray-700 rounded-lg shadow-lg py-1 max-h-64 overflow-y-auto" role="listbox">
        @if ($placeholder !== null)
