...
<head>
    <meta charset="UTF-8">
    <title>Development Has Started On Your Website</title>
</head>
                    ...
                    <tr>
                        <td style="padding:40px;">
                            ...
                            <h1 style="font-size:22px; font-weight:800; color:#111D33; margin:0 0 18px; line-height:1.3;">
                                We're building {{ $project->name }}, {{ $project->user->name }}
                            </h1>
                            <p style="font-size:15px; line-height:1.7; color:#4b5563; margin:0 0 18px;">
                                Your onboarding is complete and our team has officially started work on your website.
                                You can track progress, milestones, and everything else from your client portal
                                anytime.
                            </p>
