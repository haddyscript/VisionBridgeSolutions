                    ...
                    <tr>
                        <td style="padding:32px;">
                            <p style="font-size:14px; color:#4b5563; margin:0 0 20px;">
                                A client sent a new chat message on their project portal.
                            </p>

                            <h2 style="font-size:15px; color:#111D33; margin:0 0 10px;">Client</h2>
                            <p style="font-size:14px; color:#374151; margin:0 0 4px;">{{ $message->project->user->name }}</p>

                            <h2 style="font-size:15px; color:#111D33; margin:20px 0 10px;">Project</h2>
                            <p style="font-size:14px; color:#374151; margin:0 0 4px;">{{ $message->project->name }}</p>

                            <h2 style="font-size:15px; color:#111D33; margin:20px 0 10px;">Message</h2>
                            <p style="font-size:14px; color:#374151; margin:0; white-space:pre-line;">{{ $message->body }}</p>
                        </td>
                    </tr>
