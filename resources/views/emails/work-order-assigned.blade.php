                    ...
                    <tr>
                        <td style="padding:32px;">
                            <p style="font-size:14px; color:#4b5563; margin:0 0 20px;">
                                Hi {{ $developer->name }}, VisionBridge assigned you a {{ $itemType }} to work on.
                            </p>

                            <h2 style="font-size:15px; color:#111D33; margin:0 0 10px;">Client</h2>
                            <p style="font-size:14px; color:#374151; margin:0 0 20px;">{{ $clientName }}</p>

                            <h2 style="font-size:15px; color:#111D33; margin:0 0 10px;">{{ ucfirst($itemType) }}</h2>
                            <p style="font-size:14px; color:#374151; margin:0 0 20px; white-space:pre-line;">{{ $itemTitle }}</p>
