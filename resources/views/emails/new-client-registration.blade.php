                    ...
                    <tr>
                        <td style="padding:32px;">
                            <p style="font-size:14px; color:#4b5563; margin:0 0 20px;">
                                A new client just created an account on the portal.
                            </p>

                            <h2 style="font-size:15px; color:#111D33; margin:0 0 10px;">Name</h2>
                            <p style="font-size:14px; color:#374151; margin:0 0 4px;">{{ $user->name }}</p>

                            <h2 style="font-size:15px; color:#111D33; margin:20px 0 10px;">Email</h2>
                            <p style="font-size:14px; color:#374151; margin:0;">{{ $user->email }}</p>
                        </td>
                    </tr>
