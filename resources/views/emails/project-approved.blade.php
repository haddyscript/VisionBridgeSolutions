...
<head>
    <meta charset="UTF-8">
    <title>Client Approved Project</title>
</head>
                    ...
                    <tr>
                        <td style="padding:32px;">
                            <p style="font-size:14px; color:#4b5563; margin:0 0 20px;">
                                <strong>{{ $project->user->name }}</strong> ({{ $project->name }}) approved the
                                completed website during their review period. The final payment request has been
                                created automatically.
                            </p>

                            <h2 style="font-size:15px; color:#111D33; margin:0 0 6px;">Final Payment</h2>
                            <p style="font-size:14px; color:#374151; margin:0 0 20px;">{{ $finalPayment->formattedAmount() }}</p>
