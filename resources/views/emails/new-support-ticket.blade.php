                    ...
                    <tr>
                        <td style="padding:32px;">
                            <p style="font-size:14px; color:#4b5563; margin:0 0 20px;">
                                {{ $ticket->user->name }} ({{ $ticket->project->name }}) opened a new support ticket.
                            </p>

                            <h2 style="font-size:15px; color:#111D33; margin:0 0 10px;">{{ $ticket->subject }}</h2>
                            <p style="font-size:14px; color:#374151; margin:0 0 20px; white-space:pre-line;">{{ $ticket->message }}</p>
