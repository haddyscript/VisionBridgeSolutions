...
<head>
    <meta charset="UTF-8">
    <title>Your Consultation Has Been Rescheduled</title>
</head>
                ...
                <table role="presentation" width="100%" cellpadding="0" cellspacing="0" style="max-width:600px; background-color:#ffffff; border-radius:14px; overflow:hidden;">
                    ...
                    <tr>
                        <td style="padding:32px;">
                            ...
                            <p style="font-size:14px; color:#374151; margin:0 0 20px;">Your consultation with VisionBridge Solutions has been moved to a new time:</p>
                            ...
                            <p style="font-size:14px; color:#374151; margin:0;">If this new time doesn't work for you, just reply to this email and we'll find another slot.</p>
