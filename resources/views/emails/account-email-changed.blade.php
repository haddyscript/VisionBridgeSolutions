                ...
                <table role="presentation" width="100%" cellpadding="0" cellspacing="0" style="max-width:600px; background-color:#ffffff; border-radius:14px; overflow:hidden;">
                    ...
                    <tr>
                        <td style="padding:32px;">
                            ...
                            <p style="font-size:14px; color:#374151; margin:0 0 20px;">The email address on your VisionBridge Solutions account was just changed:</p>

                            <p style="font-size:14px; color:#374151; margin:0 0 6px;">From: <strong>{{ $oldEmail }}</strong></p>
                            <p style="font-size:14px; color:#374151; margin:0 0 20px;">To: <strong>{{ $newEmail }}</strong></p>
