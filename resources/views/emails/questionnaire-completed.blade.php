...
<head>
    <meta charset="UTF-8">
    <title>Onboarding Questionnaire Completed</title>
</head>
                    ...
                    <tr>
                        <td style="padding:32px;">
                            <p style="font-size:14px; color:#4b5563; margin:0 0 20px;">
                                <strong>{{ $questionnaire->project->user->name }}</strong> ({{ $questionnaire->project->name }})
                                just completed their onboarding questionnaire. Review it in the admin dashboard to
                                continue with the initial 50% deposit request.
                            </p>

                            <a href="{{ route('admin.projects.show', $questionnaire->project) }}"
