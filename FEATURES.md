...
| Payments | Clients see what's owed and paid, pay securely online, search/filter their payment history, and download/print a receipt or their full statement. Unpaid one-time payments are labeled "Payment Needed" in amber (instead of a neutral "Pending") so it reads clearly as something the client must act on |
