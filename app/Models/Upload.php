...
class Upload extends Model
{
     ...
     * 'open' lets a developer explicitly set a work order back to "not
     * started" — mirrors ProjectRequest::DEVELOPER_STATUSES, see that
     * constant for why 'open' has to sit first in the list.
     */
