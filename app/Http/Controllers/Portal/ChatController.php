...
class ChatController extends Controller
{
    ...
    /**
     * Sets or clears this message's single shared reaction — either side
     * can react to any message (their own or the other's, see
     * ChatMessage::REACTIONS), and sending the same emoji that's already
     * set clears it (a toggle, resolved server-side so it stays correct
     * even with two tabs open). Broadcasts live so the other side sees it
     * without a reload.
     */
